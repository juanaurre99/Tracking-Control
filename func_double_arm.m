...
% ------- NEW: Save training data for reproducibility -------
save('fixed_robot_training_data.mat', 'xy', 'q', 'qdt', 'q2dt', 'tau', ...
...
save(['./choose_file/all_traj_', time_today, '_' num2str(randi(9999)) '_' num2str(randi(9999)) '.mat'], ...
    'time_infor', 'input_infor', 'res_infor', 'properties', ...
